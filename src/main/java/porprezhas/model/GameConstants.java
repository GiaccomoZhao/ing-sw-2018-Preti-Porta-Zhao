...
public class GameConstants {
    ...
    public static final double TIMEOUT_ROUND_SEC = 33;     //33;             // this game should spends at max 45 min: 45*60 == 33(sec)*4(players)*2*10(round) + 60
    public static final double TIMEOUT_ROUND_SOLITAIRE_SEC = 90;// 90;   // solitaire should spend 30 min: 90sec * 2*10round == 30min
